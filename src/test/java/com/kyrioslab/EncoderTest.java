...
public class EncoderTest {
    ...
    public void attributesTest() {
        ...
        ca.setDuration(100);
        ca.setFormat("test");
        ca.setInputFile("testFile");
        ca.enableAudio();
        ca.enableVideo();

        for (Object o : ca.getAttributes().entrySet().toArray()) {
            System.out.print(o.toString() + " ");
        }
    }

    @Test
    public void videoSizeAttributeTest() {
        VideoSize vsize = new VideoSize("100x200");

        assertEquals(100, vsize.getWidth());
        assertEquals(200, vsize.getHeight());
    }
}